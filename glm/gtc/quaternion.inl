...
#	if !GLM_HAS_DEFAULTED_FUNCTIONS || defined(GLM_FORCE_CTOR_INIT)
		template<typename T, qualifier Q>
		GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tquat<T, Q>::tquat()
...
#	if !GLM_HAS_DEFAULTED_FUNCTIONS
		template<typename T, qualifier Q>
		GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tquat<T, Q>::tquat(tquat<T, Q> const& q)
...
#	endif//!GLM_HAS_DEFAULTED_FUNCTIONS
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tquat<T, Q>::tquat(tquat<T, P> const& q)
		: x(q.x), y(q.y), z(q.z), w(q.w)
	{}
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tquat<T, Q>::tquat(T s, vec<3, T, Q> const& v)
		: x(v.x), y(v.y), z(v.z), w(s)
	{}

	template <typename T, qualifier Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tquat<T, Q>::tquat(T _w, T _x, T _y, T _z)
		: x(_x), y(_y), z(_z), w(_w)
	{}
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tquat<T, Q>::tquat(tquat<U, P> const& q)
		: x(static_cast<T>(q.x))
		, y(static_cast<T>(q.y))
		, z(static_cast<T>(q.z))
		, w(static_cast<T>(q.w))
